...
exports.createChild = async(req, res) => {
    try{
        const { identityNo, gender, name, profImgUrl, userid, relationship } = req.body;
        const {newChild, newAuth} = await childService.createChild(identityNo, gender, name, profImgUrl, userid, relationship);
